# Overview
SCAN is a mod installer and manager for **_Spaceflight Simulator_** that installs mods and manages dependencies and conflicts with other mods.

# Features
- Installing Mods Online
- Intuitive UI
- Open Source

# Future Improvements:
- Conflict and Dependency Management System 
- Advanced Settings 
- Mod.json Generator for SCAN
- Translations
